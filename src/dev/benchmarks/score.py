...
print(model_name)
dataset = sys.argv[2]
prompts = pd.read_json(f"{data_storage}/benchmarks/prompts/{model_name}/{dataset}_score.jsonl", orient="records", lines=True)
for aspect in aspects:
    outpath = f"{data_storage}/benchmarks/scores/{model_name}"
